...
public class NativeBridge {
  ...
  public static class VpnEventHandler {
    ...
    public void closeFlutterEngine(@NonNull VoidResult result) {
      final String channelName = "dev.flutter.pigeon.pigeon_example_package.VpnEventHandler.closeFlutterEngine" + messageChannelSuffix;
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, channelName, getCodec());
      channel.send(
