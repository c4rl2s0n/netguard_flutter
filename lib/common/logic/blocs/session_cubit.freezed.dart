...
mixin _$SessionState {
 ...
 VpnConfig? get sessionConfig; SessionLogAnalysisCubit get sessionAnalysis; Map<String, Application> get systemApplicationsMap; Map<String, Application> get thirdPartyApplicationsMap;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SessionState&&(identical(other.sessionConfig, sessionConfig) || other.sessionConfig == sessionConfig)&&(identical(other.sessionAnalysis, sessionAnalysis) || other.sessionAnalysis == sessionAnalysis)&&const DeepCollectionEquality().equals(other.systemApplicationsMap, systemApplicationsMap)&&const DeepCollectionEquality().equals(other.thirdPartyApplicationsMap, thirdPartyApplicationsMap));
}


@override
int get hashCode => Object.hash(runtimeType,sessionConfig,sessionAnalysis,const DeepCollectionEquality().hash(systemApplicationsMap),const DeepCollectionEquality().hash(thirdPartyApplicationsMap));

@override
String toString() {
  return 'SessionState(sessionConfig: $sessionConfig, sessionAnalysis: $sessionAnalysis, systemApplicationsMap: $systemApplicationsMap, thirdPartyApplicationsMap: $thirdPartyApplicationsMap)';
}
...
@useResult
$Res call({
 VpnConfig? sessionConfig, SessionLogAnalysisCubit sessionAnalysis, Map<String, Application> systemApplicationsMap, Map<String, Application> thirdPartyApplicationsMap
});
...
/// Create a copy of SessionState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sessionConfig = freezed,Object? sessionAnalysis = null,Object? systemApplicationsMap = null,Object? thirdPartyApplicationsMap = null,}) {
