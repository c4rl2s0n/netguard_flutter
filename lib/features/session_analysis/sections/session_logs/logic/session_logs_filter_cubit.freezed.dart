...
mixin _$SessionLogsFilterState {
 ...
 bool get showGrouped; bool get blockedOnly; bool get allowedOnly; List<Application?> get filterApplications; LogSorting get sorting;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SessionLogsFilterState&&(identical(other.showGrouped, showGrouped) || other.showGrouped == showGrouped)&&(identical(other.blockedOnly, blockedOnly) || other.blockedOnly == blockedOnly)&&(identical(other.allowedOnly, allowedOnly) || other.allowedOnly == allowedOnly)&&const DeepCollectionEquality().equals(other.filterApplications, filterApplications)&&(identical(other.sorting, sorting) || other.sorting == sorting));
}


@override
int get hashCode => Object.hash(runtimeType,showGrouped,blockedOnly,allowedOnly,const DeepCollectionEquality().hash(filterApplications),sorting);

@override
String toString() {
  return 'SessionLogsFilterState(showGrouped: $showGrouped, blockedOnly: $blockedOnly, allowedOnly: $allowedOnly, filterApplications: $filterApplications, sorting: $sorting)';
}
...
@useResult
$Res call({
 bool showGrouped, bool blockedOnly, bool allowedOnly, List<Application?> filterApplications, LogSorting sorting
});
...
/// Create a copy of SessionLogsFilterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? showGrouped = null,Object? blockedOnly = null,Object? allowedOnly = null,Object? filterApplications = null,Object? sorting = null,}) {
...
as bool,filterApplications: null == filterApplications ? _self.filterApplications : filterApplications // ignore: cast_nullable_to_non_nullable
