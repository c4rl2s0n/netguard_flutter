...
mixin _$SplashScreenState {
 ...
 bool get loaded; bool get done; SessionCubit? get sessionCubit;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashScreenState&&(identical(other.loaded, loaded) || other.loaded == loaded)&&(identical(other.done, done) || other.done == done)&&(identical(other.sessionCubit, sessionCubit) || other.sessionCubit == sessionCubit));
}


@override
int get hashCode => Object.hash(runtimeType,loaded,done,sessionCubit);

@override
String toString() {
  return 'SplashScreenState(loaded: $loaded, done: $done, sessionCubit: $sessionCubit)';
}
...
@useResult
$Res call({
 bool loaded, bool done, SessionCubit? sessionCubit
});
...
/// Create a copy of SplashScreenState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? loaded = null,Object? done = null,Object? sessionCubit = freezed,}) {
  return _then(SplashScreenState(
...
as bool,sessionCubit: freezed == sessionCubit ? _self.sessionCubit : sessionCubit // ignore: cast_nullable_to_non_nullable
as SessionCubit?,
  ));
}
